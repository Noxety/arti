...
export default function NavLink({
    ...
    return (
        <Link
            {...props}
            className={
                "inline-flex items-center w-full border-b-2 px-4 text-white h-full py-4 text-sm font-medium leading-5 transition duration-150 ease-in-out focus:outline-none " +
                (active
